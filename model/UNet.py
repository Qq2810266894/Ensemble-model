...
#     def __init__(self, n_channels, n_classes, b_linear=True):
#         super(UNet, self).__init__()
#         self.n_channels = n_channels
#         self.n_classes = n_classes
#         self.b_linear = b_linear
#         factor = 2 if b_linear else 1
#
#         self.inc = DoubleConv(n_channels, 128)
#         self.down1 = Down(128, 256)
#         self.down2 = Down(256, 512 // factor)
#         self.up1 = Up(512, 256 // factor, b_linear)
#         self.up2 = Up(256, 128, b_linear)
#         self.outc = OutConv(128, n_classes)
#
#     def forward(self, x):
#         x1 = self.inc(x)  # [1, 128, 480, 480]
#         x2 = self.down1(x1)  # [1, 512, 240, 240]
#         x3 = self.down2(x2)  # [1, 512, 120, 120]
#         x = self.up1(x3, x2)  # [1, 256, 240, 240]
#         x = self.up2(x, x1)
#         return self.outc(x)
